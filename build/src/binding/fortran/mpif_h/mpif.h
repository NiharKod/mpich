...
!      
       ...
       INTEGER MPI_REAL2
       PARAMETER (MPI_REAL2=1275068966)
       INTEGER MPI_REAL4
       ...
       PARAMETER (MPI_COMPLEX4=1275069486)
       ...
       PARAMETER (MPI_LOGICAL1=1275068743)
       INTEGER MPI_LOGICAL2
       PARAMETER (MPI_LOGICAL2=1275069000)
       INTEGER MPI_LOGICAL4
       PARAMETER (MPI_LOGICAL4=1275069513)
       INTEGER MPI_LOGICAL8
       PARAMETER (MPI_LOGICAL8=1275070538)
       INTEGER MPI_LOGICAL16
       PARAMETER (MPI_LOGICAL16=1275072587)
