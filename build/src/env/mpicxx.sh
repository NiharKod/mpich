...
final_cxxflags=" "
final_cppflags=" "
final_ldflags=" -Wl,-rpath,/home/nkodkani/ucx/build/install/lib -Wl,-rpath,/soft/compilers/rocm/rocm-6.3.2/lib"
final_libs=""
if test "yes" = "no" -o "${interlib_deps}" = "no" ; then
    final_ldflags="${final_ldflags} -Wl,-rpath,/home/nkodkani/ucx/build/install/lib -Wl,-rpath,/soft/compilers/rocm/rocm-6.3.2/lib"
